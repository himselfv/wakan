...
//    Application.MessageBox(pchar(_l('#00635^cSeznam nauиenэch znakщ mб zastaralou strukturu a proto nebude nahrбn.^eKnown kanji list has outdated structure and will not be loaded.')),pchar(_l('#00090^eWarning^cVarovбnн')),MB_ICONWARNING or MB_OK)
  else
...
begin
  ...
  grid.FixedRows:=1;
  grid.Cells[0,0]:=_l('#00939^ePhonetic^cИtenн');
  grid.Cells[1,0]:=_l('#00632^eWritten^cZбpis');
  grid.Cells[2,0]:=_l('#00317^eTranslation^cPшeklad');
  if stat then if learn then
    grid.Cells[3,0]:=_l('#00633^eAdded / Learned^cPшidбno / Nauиeno') else
...
begin
  case i of
    0:result:=_l('#00638^eProblematic^cProblematickй');
    1:result:=_l('#00639^eUnlearned^cNenauиenй');
    2:result:=_l('#00640^eLearned^cNauиenй');
    3:result:=_l('#00641^eMastered^cDobшe nauиenй');
  end;
end;
...
begin
  ...
  colarr.add('0Kanji_Back=FFFFFF,^eBackground^cPozadн');
  colarr.add('0Kanji_Common=000000,^eCommon characters^cBмћnй znaky');
  colarr.add('0Kanji_Rare=4F4F4F,^eRare characters^cVzбcnй znaky');
  colarr.add('0Kanji_Names=005F00,^eCharacters in names^cZnaky ve jmйnech');
  colarr.add('0Kanji_Learned=7F0000,^eLearned characters^cNauиenй znaky');
  colarr.add('0Kanji_RadCommon=000000,^eCommon radicals^cBмћnй radikбly');
  colarr.add('0Kanji_RadRare=4F4F4F,^eRare radicals^cVzбcnй radikбly');
  colarr.add('0Kanji_RadLearned=7F0000,^eLearned radicals^cNauиenй radikбly');
  colarr.add('1Dict_Back=FFFFFF,^eBackground^cPozadн');
  colarr.add('1Dict_Text=000000,^eText^cText');
  colarr.add('1Dict_UnknownChar=2F2F7F,^eUnknown characters^cNeznбmй znaky');
  colarr.add('1Dict_Problematic=DDDDFF,^eProblematic words^cProblematickб slova');
  colarr.add('1Dict_Unlearned=FFEEDD,^eUnlearned words^cNenauиenб slova');
  colarr.add('1Dict_Learned=BBFFFF,^eLearned words^cNauиenб slova');
  colarr.add('1Dict_Mastered=BBFFBB,^eMastered words^cDobшe nauиenб slova');
  colarr.add('1Dict_SelBack=BBBBBB,^eBackground (selected)^cPozadн (vybranй)');
  colarr.add('1Dict_SelProblematic=9999BB,^eProblematic words (selected)^cProblematickб slova (vybranб)');
  colarr.add('1Dict_SelUnlearned=BBAA99,^eUnlearned words (selected)^cNenauиenб slova (vybranб)');
  colarr.add('1Dict_SelLearned=99BBBB,^eLearned words (selected)^cNauиenб slova (vybranб)');
  colarr.add('1Dict_SelMastered=77BB77,^eMastered words (selected)^cDobшe nauиenб slova (vybranб)');
  colarr.add('2Mark_Special=7F007F,^eSpecial markers^cSpeciбlnн pшнznaky');
  colarr.add('2Mark_Usage=00007F,^eUsage markers^cPшнznaky pouћitн');
  colarr.add('2Mark_Grammatical=7F0000,^eGrammatical markers^cGramatickй pшнznaky');
  colarr.add('2Mark_Dict=4F4F4F,^eDictionary markers^cPшнznaky slovnнku');
  colarr.add('2Mark_Lesson=004F00,^eLesson markers,^cPшнznaky lekce');
  colarr.add('3Editor_Back=FFFFFF,^eBackground^cPozadн');
  colarr.add('3Editor_Text=000000,^eText color^cBarva pнsma');
  colarr.add('3Editor_ASCII=2F2F2F,^eASCII text^cASCII text');
  colarr.add('3Editor_Active=FF0000,^eText being written^cText, kterэ je prбvм psбn');
  colarr.add('3Editor_Aftertouch=0000FF,^eText just converted^cText prбvм zkonvertovбn');
  colarr.add('3Editor_Untranslated=FFFFFF,^eUntranslated text^cNepшeloћenэ text');
  colarr.add('3Editor_NotFound=003FFF,^eText where translation failed^cText, u kterйho pшeklad selhal');
  colarr.add('3Editor_Particle=FFAAFF,^eEstimated particle^cOdhadovanб partikule');
  colarr.add('3Editor_Translated=EEEEEE,^eWord not in vocabulary^cSlovo, kterй nenн ve slovниkбch');
  colarr.add('3Editor_Problematic=DDDDFF,^eProblematic vocabulary word^cProblematickй slovниko');
  colarr.add('3Editor_Unlearned=FFEEDD,^eUnlearned vocabulary word^cNenauиenй slovниko');
  colarr.add('3Editor_Learned=BBFFFF,^eLearned vocabulary word^cNauиenй slovниko');
  colarr.add('3Editor_Mastered=BBFFBB,^eMastered vocabulary word^cDobшe nauиenй slovниko');
  colarr.add('3Editor_HintBack=EFEFEF,^eHint background^cPozadн nбpovмdy');
  colarr.add('3Editor_HintSelected=00FFFF,^eHint selected background^cVybranй pozadн nбpovмdy');
  colarr.add('3Editor_HintText=000000,^eHint text^cText nбpovмdy');
  ...
  colarr.add('4Popup_Back=A0FFFF,^eBackground^cPozadн');
  colarr.add('4Popup_Lines=000000,^eLines^cИбry');
  colarr.add('4Popup_Card=FFFFFF,^eCharacter card^cKarta znaku');
  colarr.add('4Popup_Text=000000,^eText on the caracter card^cText na kartм znaku');
